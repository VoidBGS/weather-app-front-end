...
const LoginForm = () =>{
    ...
    return (
      ...
      <Col md={{ span: 4, offset: 4 }}>
        ...
        <Form.Group>
        <Form.Row className="login-form-text justify-content-center pt-4"><Form.Label>Name</Form.Label></Form.Row>
        <Form.Control required size="md" name="name" type="text" onChange={HandleInputChange} className="login-form-input" minLength="1" maxLength="30"></Form.Control>
        ...
        <Form.Group>
        <Form.Row className="login-form-text justify-content-center pt-1"><Form.Label>Email</Form.Label></Form.Row>
