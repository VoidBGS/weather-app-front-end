...
const PrognosisDay1 = ({data}) =>{
    ...
    <Col>
      {data.main &&(<div className="weather-box">
        ...
        <Row className="weather-box-icon justify-content-center mt-3"><img src={`https://openweathermap.org/img/wn/${data.weather[0].icon}@2x.png`} alt={data.weather[0].description} style={{ width: '140px' }}></img></Row>
