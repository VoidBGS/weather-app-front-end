  ...
  console.log(data);
    ...
    <Col>
      {data.list &&(<div className="weather-box">
        ...
        <Row className="weather-box-temp justify-content-center mt-3"><div className="weather-box-temp-min pr-2">Min {Math.floor(data.list[3].main.temp_min)}°</div> /<div className="weather-box-temp-max pl-2">Max {Math.round(data.list[6].main.temp_max)}°</div></Row>
